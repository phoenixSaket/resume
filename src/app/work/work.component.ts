...
export class WorkComponent {
  ...
  public projects = [
    ...
    { title: 'Bill Printer Standalone App', description: 'A full stack Point-of-Sale standalone app for a client to print bills for their customers with a custom UI and animations with inventory, customer, bill creation and management ', link: 'https://drive.google.com/file/d/17VnKx1UCyY6akEZWHw2UR6KZtrvmIyUn/view?usp=sharing', linkText: 'Download', linkIcon: 'save_alt',  stack: ["Angular", "NodeJS", "SQLite"], isClientProject: false ,image: 'assets/Images/Projects/bill-printer.png' , openInDetails: false, detailedDescription: 'An analysis full stack web app for comparative analysis of apps from Google Play/ Apple App Store based on reviews and ratings for the apps which can generate charts, word cloud. Sentiment word clouds, add/ compare/ delete any app that is available on Google Play/ App Store. Android app APK/ IOS Source Code available to download on the website. The website enables easy comparison between your app and competitors and helps in analyzing positive and negative thoughts for your apps given by end users.', warning: ""},

    { title: 'Notes Keeper', description: 'An UI-only notes keeper web app with a custom UI and animations with notes creation and management created for gaining more experience in Angular', link: 'https://phoenixSaket.github.io/notes-keeper', stack: ["Angular"], isClientProject: false ,image: 'assets/Images/Projects/notes-keeper.png' , openInDetails: false, detailedDescription: 'An analysis full stack web app for comparative analysis of apps from Google Play/ Apple App Store based on reviews and ratings for the apps which can generate charts, word cloud. Sentiment word clouds, add/ compare/ delete any app that is available on Google Play/ App Store. Android app APK/ IOS Source Code available to download on the website. The website enables easy comparison between your app and competitors and helps in analyzing positive and negative thoughts for your apps given by end users.', warning: ""},
    ...
    { title: 'Apple Health Kit', description: 'Responsible for the system design, architecture and flow creation, execution and maintenance for the whole project to sync data from iPhone\'s Apple Health app to the client\'s app. Delivered bug-less requirements to the client. Received multiple client appreciations.', link: '', stack: ['Capacitor', 'Angular'], isClientProject: true, image: 'assets/Images/Projects/health.png' , openInDetails: false, detailedDescription: 'Responsible for the system design, architecture and flow creation, execution and maintenance for the whole project to authorize members into the app using credentials, biometrics along with MFA. Reading the data from user\'s iPhone, formatting into FHIR clinical format and then send to backend to store in DB for later retrieval. Received multiple client appreciations.', warning: ""},
